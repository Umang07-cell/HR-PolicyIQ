...
export interface Citation { document_id: number; document_title: string; chunk_text: string; score: number; page?: number; }
export interface ChatMessage { role: "user" | "assistant"; content: string; citations?: Citation[]; confidence?: number; }
