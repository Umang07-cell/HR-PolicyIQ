...
export const MetricsPanel = ({ stats }: { stats: DashboardStats }) => (
  <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
    ...
    />
    <StatCard label="Documents" value={stats.total_documents} color="purple"
    ...
    />
    <StatCard label="Indexed Docs" value={stats.indexed_documents} color="green"
      icon={<Icon path="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />}
    />
    <StatCard label="Chat Queries" value={stats.total_queries} color="blue"
    ...
    />
    <StatCard label="Pending Leaves" value={stats.pending_leaves} color="amber"
      icon={<Icon path="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />}
    />
    <StatCard label="Open Grievances" value={stats.open_grievances} color="red"
